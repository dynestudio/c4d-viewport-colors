...
#color id to apply
#primaries
gcolor = c4d.Vector(1,0,0) #red
gcolor = c4d.Vector(0,1,0) #green
gcolor = c4d.Vector(0,0,1) #blue
#secondaries
gcolor = c4d.Vector(1,1,0) #yellow
gcolor = c4d.Vector(0,1,1) #cyan
gcolor = c4d.Vector(1,0,1) #pink
#terciaries
gcolor = c4d.Vector(1,0.5,0) #orange
gcolor = c4d.Vector(0.7,1,0) #leaf
gcolor = c4d.Vector(0.5,0,1) #purple
#greys
gcolor = c4d.Vector(1,1,1) #white
gcolor = c4d.Vector(0.6,0.6,0.6) #grey light
gcolor = c4d.Vector(0.3,0.3,0.3) #grey dark
#darker & desaturared colors
gcolor = c4d.Vector(0.7,0,0) #dark red
gcolor = c4d.Vector(0,0.7,0) #dark green
gcolor = c4d.Vector(0.1,0.1,0.6) #dark blue
gcolor = c4d.Vector(0.8,0.7,0) #dark yellow
gcolor = c4d.Vector(0.3,0.6,0.6) #dark cyan
