...
#color id to apply
#primaries
vcolor = c4d.Vector(1,0,0) #red
vcolor = c4d.Vector(0,1,0) #green
vcolor = c4d.Vector(0,0,1) #blue
#secondaries
vcolor = c4d.Vector(1,1,0) #yellow
vcolor = c4d.Vector(0,1,1) #cyan
vcolor = c4d.Vector(1,0,1) #pink
#terciaries
vcolor = c4d.Vector(1,0.5,0) #orange
vcolor = c4d.Vector(0.7,1,0) #leaf
vcolor = c4d.Vector(0.5,0,1) #purple
#greys
vcolor = c4d.Vector(1,1,1) #white
vcolor = c4d.Vector(0.6,0.6,0.6) #grey light
vcolor = c4d.Vector(0.3,0.3,0.3) #grey dark
#darker & desaturared colors
vcolor = c4d.Vector(0.7,0,0) #dark red
vcolor = c4d.Vector(0,0.7,0) #dark green
vcolor = c4d.Vector(0.1,0.1,0.6) #dark blue
vcolor = c4d.Vector(0.8,0.7,0) #dark yellow
vcolor = c4d.Vector(0.3,0.6,0.6) #dark cyan
vcolor = c4d.Vector(0.4,0.3,0.5) #dark pink
